    ...
    if ldap_user:
        ...
        if "bloggers" in ldap_groups:
            ...
            send_mail(
                ...
                message="Has sido registrado en BookLook",
                from_email="antonio.moreno.varilla.alu@iesfernandoaguilar.es",
                recipient_list=[user.email, "antonio.moreno.varilla.alu@iesfernandoaguilar.es"],
                fail_silently=False
            )